...
The other algebra RL + RL = delta + (non-closure) is also given. Explicit representation of any matrix is given by L[1] // Matrix Form (replace 1 with whichever index).
